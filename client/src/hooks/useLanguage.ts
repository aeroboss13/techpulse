...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'code.tryAgain': 'Try again',
    'code.download': 'Download',
    'code.downloaded': 'Downloaded!',
    'code.downloadFailed': 'Download failed',
    'code.delete': 'Delete',
    'code.edit': 'Edit',
  ...
  ru: {
    ...
    'code.copyFailed': 'Ошибка копирования',
    'code.tryAgain': 'Попробуйте снова',
    'code.download': 'Скачать',
    'code.downloaded': 'Скачано!',
    'code.downloadFailed': 'Ошибка скачивания',
    'code.delete': 'Удалить',
    'code.edit': 'Изменить',
    'code.language': 'Язык',
    'code.title': 'Название',
