...
const translations: Record<Language, Record<string, string>> = {
  ...
  ru: {
    ...
    'snippets.searchPlaceholder': 'Поиск ваших сниппетов',
    'snippets.cancel': 'Отмена',
    'snippets.save': 'Сохранить',
    'snippets.create': 'Создать',
    'snippets.update': 'Обновить',
    'snippets.snippet': 'сниппет',
    'snippets.newSnippet': 'Новый сниппет',
    'snippets.editSnippet': 'Редактировать сниппет',
    'snippets.noSnippets': 'Сниппетов пока нет',
    'snippets.noSnippetsDesc': 'Создайте свой первый сниппет кода, чтобы сохранить его для дальнейшего использования!',
    'snippets.noMatching': 'Нет подходящих сниппетов',
    'snippets.tryDifferentSearch': 'Попробуйте другие поисковые запросы',
    'snippets.noPublicSnippets': 'Нет публичных сниппетов',
    'snippets.beFirstToShare': 'Станьте первым, кто поделится публичным сниппетом с сообществом!',
