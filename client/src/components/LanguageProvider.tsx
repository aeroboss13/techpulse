...
const translations: Record<Language, Record<string, string>> = {
  ...
  ru: {
    ...
    'profile.likesRu': 'Лайки',
    'profile.codeSnippetsRu': 'Сниппеты кода',
    'profile.noPostsRu': 'Пока нет постов',
    'profile.noPostsOwnRu': 'Вы еще ничего не публиковали. Поделитесь своим первым постом!',
    'profile.noPostsUserRu': 'Этот пользователь еще ничего не публиковал.',
    'profile.noLikesRu': 'Пока нет лайков',
    'profile.noLikesDescRu': 'Посты, понравившиеся этому пользователю, появятся здесь.',
    'profile.noSnippetsRu': 'Нет сниппетов кода',
    'profile.noSnippetsDescRu': 'Сниппеты кода этого пользователя появятся здесь.',
